/* ============================================================================
   ...
   { name: "Dish Ka Naam", note: "Chhoti si detail", options: [
       { label: "Size/Weight ka naam", price: 149 }
   ]}

   - name    = dish ka naam
   - note    = chhoti detail line (ingredients waghera) — "" bhi likh sakte hain
   - options = ek list hai jisme har size/weight/portion ka apna price hai:
       ...
       * Kisi item mein Small nahi hai (sirf Medium/Large) to bas woh do
         ...
         website par dikhenge.
       * Mithai (weight ke hisaab se) ke liye:
           options: [
  ...
  categories: [
    {
      ...
      title: "Mithai",
      icon: "mithai",
      description: "Khaalis ghee aur taaza mawa se banayi gayi, roz taazi. Weight chunein.",
      items: [
        { name: "Kaju Katli", note: "Kaju se banayi gayi premium mithai", options: [
          { label: "250g", price: 140 }, { label: "500g", price: 275 }, { label: "1kg", price: 550 }
        ]},
        { name: "Gulab Jamun", note: "Garam garam, chashni mein doobe hue", options: [
          { label: "250g", price: 75 }, { label: "500g", price: 145 }, { label: "1kg", price: 280 }
        ]},
        { name: "Rasgulla", note: "Naram aur spongy, bangaali style", options: [
          { label: "250g", price: 70 }, { label: "500g", price: 135 }, { label: "1kg", price: 260 }
        ]},
        { name: "Khoya Barfi", note: "Khoye se banayi, halki elaichi ke saath", options: [
          { label: "250g", price: 125 }, { label: "500g", price: 245 }, { label: "1kg", price: 480 }
        ]},
        { name: "Motichoor Laddoo", note: "Boondi se bana, tyoharon ka favourite", options: [
          { label: "250g", price: 85 }, { label: "500g", price: 165 }, { label: "1kg", price: 320 }
        ]},
        { name: "Rasmalai", note: "Malaidar doodh mein bhige rasgulle", options: [
          { label: "250g", price: 90 }, { label: "500g", price: 175 }, { label: "1kg", price: 340 }
        ]},
        { name: "Peda", note: "Traditional khoya peda", options: [
          { label: "250g", price: 95 }, { label: "500g", price: 185 }, { label: "1kg", price: 360 }
        ]},
